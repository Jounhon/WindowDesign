...
namespace DrawingModel
{
    class GoogleDriveService
    {
        ...
        string _projectPath = Path.GetDirectoryName(Path.GetDirectoryName(Directory.GetCurrentDirectory())) + "\\Resources";

        ///
        /// show message box
        ///
        void ShowMessage(string contect)
        {
            MessageBox.Show(contect, "Error!", MessageBoxButtons.OK);
        }
        ...
        private void CreateNewService(string applicationName, string clientSecretFileName)
        {
            ...
            using (FileStream stream = new FileStream(_projectPath + clientSecretFileName, FileMode.Open, FileAccess.Read))
            {
